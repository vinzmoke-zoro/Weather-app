    ...
    request({url, json: true}, (error, {body}) => {
      if(error){
       callback("Unable to connect to the weather service.Please check your Internet connection.", undefined)
          ...
          callback(undefined, body.daily[0].weather[0].description + " throughout the day.<br>Temperature : " + body.current.temp.toFixed(0) + "&deg;C.<br>Humidity : " + body.current.humidity + "%.")
      }
  })
} 
